...
if ($hassiteconfig) {
    $ADMIN->add('courses', new admin_externalpage('tool_uploadmanualmarks',
            get_string('pluginname', 'tool_uploadmanualmarks'),
            new moodle_url('/admin/tool/uploadmanualmarks/')
    ));
}