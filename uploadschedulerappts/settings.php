...
if ($hassiteconfig) {
    $ADMIN->add('courses', new admin_externalpage('tool_uploadschedulerappts',
            get_string('pluginname', 'tool_uploadschedulerappts'),
            new moodle_url('/admin/tool/uploadschedulerappts/')
    ));
}